...
* [ctrlp.vim](https://github.com/ctrlpvim/ctrlp.vim): Fuzzy file, buffer, mru and tag finder. Can be opened with `<Ctrl+F>`. It also map `<leader+d>` to toggle buffer tags from current file, somewhat like `Super + R` shortcut the Sumblime Text uses.
